...
export default function MembersPage() {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <p data-testid="error-state" className="text-red-600 text-lg font-medium">{error}</p>
      </div>
    );
  }

  return (
    <div data-testid="members-page" className="min-h-screen bg-blue-50 py-10 px-6 mt-10">
      <h1 data-testid="members-title" className="text-3xl font-bold text-blue-700 text-center mb-2">
        Members
      </h1>
      <p data-testid="total-members" className="text-center text-gray-600 mb-8">
      ...
      {members.length === 0 ? (
        ...
        <div data-testid="members-grid" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {members.map((m) => (
            <div
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-3">
                ...
                />
                <div>
                  <h2 data-testid="member-name" className="font-semibold text-blue-800 text-lg">
                    {m.name}
                  </h2>
